...
/**
 * Converter class for Long variables to convert from KNIME Data Type to Avro
 * and vice versa.
 * 
 * @author Mete Can Akar
 *
 */
public class LongPFAConverter implements PFADataTypeConverter {
