 ...
 */
package org.knime.ext.pfa.data.converters;
...
import org.knime.ext.pfa.data.PFADataTypeConverter;

/**
 * Converter class for Boolean variables to convert from KNIME Data Type to Avro
 * and vice versa.
 * 
 * @author Mete Can Akar
 *
 */
public class BooleanPFAConverter implements PFADataTypeConverter {
    ...
    public Function<Object, DataCell> createPFAToCellMapper(final Schema schema) {
        return (o) -> {
            ...
            return (Boolean) o ? BooleanCell.TRUE : BooleanCell.FALSE;
        };
    }
}
